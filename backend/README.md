...
## Project Structure
    ...
    ├── crm_job_posters_tem_38033  # Django project configurations
...
1. Clone this repo and `cd crm_job_posters_tem_38033`
...
2. Clone this repo and `cd crm_job_posters_tem_38033`
